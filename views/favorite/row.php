        ...
        <tr>
            ...
            <td class="td-actions text-center">
                <button type="button" rel="tooltip" class="btn btn-primary btn-simple btn-icon btn-sm">
                    <i class="tim-icons icon-heart-2" onclick="appVue.confirmDeleteFavorite(<?php echo $row->id; ?>, '<?php echo $row->nombre; ?>',controller, event);"></i>
                </button>
                <button type="button" rel="tooltip" class="btn btn-info btn-simple btn-icon btn-sm"
                        onclick="appVue.detailFavorite(<?php echo $row->id; ?>)"
